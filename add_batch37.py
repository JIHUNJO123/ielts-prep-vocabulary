...
NEW_WORDS = [
    ("autonomy","noun","the right of self-government","Regional autonomy."),
    ("avalanche","noun","a mass of snow sliding down a mountain","Avalanche warning."),
    ("averse","adjective","having a strong dislike","Risk averse."),
    ("avert","verb","prevent or ward off","Avert disaster."),
    ("aviation","noun","the flying of aircraft","Civil aviation."),
    ("avid","adjective","having an enthusiastic interest","An avid reader."),
    ("await","verb","wait for an event","Await the results."),
]
