...
abstract class AppLocalizations {
  ...
  /// No description provided for @band45.
  ///
  /// In en, this message translates to:
  /// **'Foundation (Band 4.5-5.5)'**
  String get band45;

  /// No description provided for @band45Desc.
  ///
  /// In en, this message translates to:
  /// **'Basic vocabulary - 1,200 words'**
  String get band45Desc;

  /// No description provided for @band60.
  ///
  /// In en, this message translates to:
  /// **'Competent (Band 6.0-6.5)'**
  String get band60;

  /// No description provided for @band60Desc.
  ///
  /// In en, this message translates to:
  /// **'Academic vocabulary - 1,800 words'**
  String get band60Desc;

  /// No description provided for @band70.
  ///
  /// In en, this message translates to:
  /// **'Good User (Band 7.0-7.5)'**
  String get band70;

  /// No description provided for @band70Desc.
  ///
  /// In en, this message translates to:
  /// **'Advanced expressions - 1,200 words'**
  String get band70Desc;
  ...
  /// No description provided for @band80Desc.
  ///
  /// In en, this message translates to:
  /// **'Expert vocabulary - 800 words'**
  String get band80Desc;
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'de', 'en', 'es', 'fr', 'ja', 'ko', 'pt', 'vi', 'zh'].contains(locale.languageCode);
