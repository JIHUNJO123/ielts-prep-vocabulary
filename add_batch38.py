...
NEW_WORDS = [
    ("axe","noun","a tool used for chopping wood","Chop with an axe."),
    ("axiom","noun","a statement accepted as true","A fundamental axiom."),
    ("azure","adjective","bright blue in color","Azure sky."),
    ("babble","verb","talk rapidly in a foolish way","Babble incoherently."),
    ("backbone","noun","the spine","The backbone of the organization."),
]
